...
export const DoctorMyDataOverview: FC = () => {
  ...
  // Выбор обработки сразу сохраняет только новый аватар. Раньше флаг ждал
  // общего «Сохранить», и после клика по варианту в Network не было запроса.
  const saveSelectedPhoto = async (shouldProcess: boolean) => {
    ...
    try {
      ...
      // Ошибку уже выводит useDoctorCabinet; даём выбрать вариант повторно.
    }
  };
