...
// Выбора способа оплаты при регистрации клиники больше нет: оплата у всех
// только онлайн. Отправляем фиксированное значение, а не пустой массив —
// бэк поле не требует, но пустой список означал бы «способ неизвестен», а он
// известен. Если появится фильтр по оплате, данные уже будут корректными.
export const CLINIC_PAYMENT_METHODS = ["Онлайн"];
