// Каркас загрузки страницы. Живёт здесь, а не в app/.../loading.tsx, потому что
// нужен в двух местах: серверному loading.tsx и клиентской ветке самой
// страницы. Раньше вторая рисовала голый текст «Загрузка...» поверх уже
// отрисованного скелета.
import { Footer } from "@/widgets/footer";
import { Header } from "@/widgets/header";

export const SpecialistDetailsSkeleton = () => {
  return (
