...
const TABS: { id: SavedType; label: string; icon: () => ReactNode }[] = [
  { id: "clinic", label: "Клиники", icon: ClinicIcon },
  { id: "doctor", label: "Специалисты", icon: DoctorIcon },
  { id: "service", label: "Услуги", icon: ServiceIcon },
];
