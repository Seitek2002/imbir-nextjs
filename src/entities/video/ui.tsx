...
export const VideoCard: FC<Props> = ({
  ...
  return (
    <a
      ...
      className="bg-white rounded-3xl border border-[#E3E4E5] overflow-hidden flex flex-col w-full shrink-0 group"
    >
      <div className="relative aspect-video w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="size-12 rounded-full bg-white/90 flex items-center justify-center shadow-md">
            <svg
              viewBox="0 0 24 24"
              className="size-5 fill-[#FFA18D] stroke-[#FFA18D]"
      ...
      <div className="flex flex-col gap-2 p-3">
        ...
        <div className="flex items-center gap-1.5 text-xs text-[#686F72]">
