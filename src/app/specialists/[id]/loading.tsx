  ...
  return (
    <main className="min-h-screen bg-[#F2F3F5] md:bg-white flex flex-col relative pb-20 md:pb-0">
      ...
      <div className="flex-1 w-full max-w-350 mx-auto md:px-10 flex flex-col pt-0 md:pt-6 pb-10">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10">
          ...
          <div className="relative w-full md:w-100 shrink-0">
            <div className="relative w-full h-85 md:h-125 bg-gray-200 animate-pulse md:rounded-3xl overflow-hidden" />
          </div>
          ...
          <div className="flex-1 flex flex-col bg-white rounded-t-3xl md:rounded-none -mt-6 md:mt-0 relative z-10 p-5 md:p-0">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="w-full">
                <div className="h-8 md:h-10 w-3/4 md:w-1/2 bg-gray-200 animate-pulse rounded-lg mb-3" />
                <div className="h-5 w-1/3 md:w-1/4 bg-gray-200 animate-pulse rounded-md" />
              </div>
            </div>
        ...
        <div className="mt-10 md:mt-20 px-5 md:px-0">
          <div className="h-8 w-32 bg-gray-200 animate-pulse rounded-md mb-6" />
        ...
        <div className="mt-10 md:mt-20 mb-10 md:mb-20 px-5 md:px-0">
          ...
          <div className="flex gap-4 overflow-hidden">
            ...
            <div className="h-48 w-70 bg-gray-200 animate-pulse rounded-2xl shrink-0" />
            <div className="hidden md:block h-48 w-70 bg-gray-200 animate-pulse rounded-2xl shrink-0" />
            <div className="hidden md:block h-48 w-70 bg-gray-200 animate-pulse rounded-2xl shrink-0" />
            <div className="hidden lg:block h-48 w-70 bg-gray-200 animate-pulse rounded-2xl shrink-0" />
          </div>
        </div>
      </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white p-4 border-t border-[#E3E4E5] z-50">
        <div className="h-13 w-full bg-gray-200 animate-pulse rounded-xl" />
      </div>
    </main>
  );
}
