      ...
      <div className="px-4 py-6">
        ...
        <div className="bg-gradient-to-br from-[#FFE5DC] to-[#FFD4C8] rounded-3xl p-6 mb-4 flex flex-col items-center">
          <div className="w-24 h-24 rounded-full overflow-hidden mb-4 bg-white">
            <div className="w-full h-full flex items-center justify-center text-[#838A8D] text-3xl font-semibold">
              АК
            </div>
          </div>
          <h2 className="text-[#191A1B] font-semibold text-lg">Айжан К. К.</h2>
          <p className="text-[#686F72] text-sm mt-1">aijank@gmail.com</p>
        </div>
